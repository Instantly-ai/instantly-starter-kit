---
title: "Emails (Unibox & replies)"
description: "Read the inbox and reply to threads."
---

Read and act on the emails in the Unibox — campaign sends, replies, and manual messages. Reach for this group to build a reply inbox, auto-respond, or forward. Related: [webhooks](./webhooks) (get notified of replies), [leads](./leads) (update interest from a reply).
...
## See also
Example: [`examples/06-reply-webhook`](https://github.com/Instantly-ai/instantly-starter-kit/blob/main/js/examples). Template: [`reply-automation`](https://github.com/Instantly-ai/instantly-starter-kit/blob/main/js/templates/reply-automation). See [webhooks](./webhooks).
