---
title: "Leads (+ lists & labels)"
description: "Add, verify, and organize leads and lists."
---

Add, list, move, and update the people you email. **Leads** live in **lead lists** and/or campaigns; **lead labels** categorize replies/interest. Reach for this group to build an audience and manage its state. Related: [enrichment](./enrichment) (source + enrich leads), [verification](./verification) (clean them), [campaigns](./campaigns) (send to them).
...
## See also
Example: [`examples/03-add-leads-verify`](https://github.com/Instantly-ai/instantly-starter-kit/blob/main/js/examples). Templates: [`outreach-service`](https://github.com/Instantly-ai/instantly-starter-kit/blob/main/js/templates/outreach-service), [`lead-pipeline`](https://github.com/Instantly-ai/instantly-starter-kit/blob/main/js/templates/lead-pipeline). See [verification](./verification) and [conventions → pagination](./conventions#pagination).
