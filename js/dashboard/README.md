...
working reference for building your *own* service on the same SDK + domain core.
No auth, no database. One Next.js app that reads your key server-side, fans out
across your client workspaces, and never ships a secret to the browser.

<p align="center">
  <img src="core/public/docs/overview.png" alt="Agency console overview — client roster and headline stats" width="900">
</p>
...
<p align="center">
  ...
  <a href="#deploy-standalone">Deploy</a> ·
